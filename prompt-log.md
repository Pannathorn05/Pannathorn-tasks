...
## 2569-09-23 แก้ tasks.md รอบที่ 4 (แยก T-21)

- เครื่องมือ: Claude Code (VS Code ใน Codespaces)
- ไฟล์: specs/001-booking/tasks.md
- แก้อะไร:
  - T-21 เดิม "ต่อหน้าจอกับ API จริง" (ต้องทำหลัง 9 task) แยกเป็น 2 task
    - T-21 "ต่อหน้าเลือกช่วงเวลากับ GET /slots จริง พร้อมข้อมูลตัวอย่าง" ต้องทำหลัง T-04, T-17 สถานะ พร้อมทำ
    - T-22 (ใหม่) "ต่อหน้ายืนยันและหน้าผลการจองกับ POST /bookings จริง" ต้องทำหลัง T-05, T-06, T-07, T-11, T-18, T-19, T-20, T-21 สถานะ รอทีมตัดสินใจ (ข้อสังเกต 1 และ 2) เหมือน T-21 เดิม
  - แก้บรรทัดสรุปหัวไฟล์เป็น 22 task และเปลี่ยนการอ้าง T-21 ในข้อสังเกต 1 และ 2 เป็น T-22
